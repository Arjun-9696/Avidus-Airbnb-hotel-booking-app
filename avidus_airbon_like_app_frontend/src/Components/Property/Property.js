...
const Property = () => {
    ...
    const fetchProperties = async () => {
        try {
            const response = await axios.get(`https://avidus-backend.onrender.com/listings/${id}`);
    ...
    const handleBooking = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://avidus-backend.onrender.com/booking', data);
            toast({
                        ...
                        >
                            ...
                            <Stack>
                                <CardBody>
                                    ...
                                    <Text fontSize={20}>{property.location}</Text>
                    ...
                    <Box marginRight={40} marginTop={20}>
                        ...
                        <Stack direction={{ base: 'column', sm: 'row' }}>
                            <Box margin={'auto'}>
                                ...
                                <Heading size="md" py={2} textDecoration={'line-through'}>
                                    ₹ {Total}
                                </Heading>
                                <Heading size="md" py={2} fontSize="2xl" color="blue.600">
                                    ₹ {finalPrice}
                                </Heading>
                                <Button
                                    variant="solid"
